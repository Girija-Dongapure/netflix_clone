...
function HistoryPage() {
    ...
    console.log("searchHiatory-----",searchHistory);
                ...
                {searchHistory?.map((entry) => {
                    return (
                        <div key={entry.id} className='bg-gray-800 p-4 rounded flex items-start'>
                            <img src={SMALL_IMG_BASE_URL+entry.image} alt="img" className='size-16 object-cover rounded-full mr-4'/>
                            ...
                            <Trash className='size-5 ml-5 mt-1 cursor-pointer hover:fill-red-600 hover:text-red-600' onClick={()=>handleDelete(entry)}/>
                        </div>
                    )
                })}
                </div>
